...
<div id="side">
	...
	<div class="main">
		<form action="ticketing.do" method="post">
			<img class="movieinfo" src="/movie/image/Fast & Furious 9 THE FAST SAGA.jpg" width=350px height=450px><br>
			...
			<input type="hidden" name="job" value="Fast & Furious 9 THE FAST SAGA">
