...
<div id="side">
	...
	<div class="main">
		<form action="ticketing.do" method="post">
			<img class="movieinfo" src="/movie/image/Harry Potter And The Sorcerer's Stone.jpg"><br>
			...
			<input type="hidden" name="job" value="Harry Potter And The Sorcerer's Stone">
